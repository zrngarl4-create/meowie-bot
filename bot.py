...
WORD_GUESS_START_COMMAND = "حدس کلمه"
...
def _ensure_all_tables():
    ...
    db.ensure_word_bank_table()
    if db.get_word_bank_count() == 0:
        db.add_words_to_bank(WORD_BANK_SEED)
    db.ensure_trivia_table()
    if db.get_trivia_question_count() == 0:
        db.add_trivia_questions(TRIVIA_BANK_SEED)
